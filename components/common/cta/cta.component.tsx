...
export default function CTA() {
  return (
    <section className="bg-gradient-to-t from-black from-50% to-white to-50% md:from-25% md:to-25%">
      <div className="mx-auto flex max-w-xs flex-col items-center gap-8 overflow-hidden rounded-2xl bg-peach bg-[url('/assets/shared/desktop/bg-pattern-call-to-action.svg')] bg-cta bg-no-repeat px-6 py-16 md:max-w-2xl md:bg-cta-tablet md:py-14 xl:max-w-6xl xl:flex-row xl:justify-between xl:bg-right xl:px-24 xl:py-[4.5rem]">
